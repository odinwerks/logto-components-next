...
ARG NEXT_PUBLIC_DELETE_REDIRECT_DELAY
ARG NEXT_PUBLIC_SIGNOUT_REDIRECT_DELAY
ARG NEXT_PUBLIC_BACKEND_TYPE
ARG NEXT_PUBLIC_FORCE_ANIMATIONS
...
ENV NEXT_PUBLIC_DELETE_REDIRECT_DELAY=$NEXT_PUBLIC_DELETE_REDIRECT_DELAY
ENV NEXT_PUBLIC_SIGNOUT_REDIRECT_DELAY=$NEXT_PUBLIC_SIGNOUT_REDIRECT_DELAY
ENV NEXT_PUBLIC_BACKEND_TYPE=$NEXT_PUBLIC_BACKEND_TYPE
ENV NEXT_PUBLIC_FORCE_ANIMATIONS=$NEXT_PUBLIC_FORCE_ANIMATIONS
