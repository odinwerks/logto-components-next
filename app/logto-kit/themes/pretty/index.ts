// =============================================================================
// Pretty Theme — themes/pretty/index.ts
//
// This file is the canonical source of ALL visual properties for the pretty
...
function buildDefaultTheme(mode: 'dark' | 'light'): ThemeSpec {
  ...
  const shadows: ThemeShadows = {
    ...
    modal:   isDark
      ? '0 2rem 5.625rem rgba(0,0,0,0.6), 0 0 0 1px rgba(255,255,255,0.06)'
      : '0 2rem 5.625rem rgba(0,0,0,0.15), 0 0 0 1px rgba(0,0,0,0.05)',
  };
