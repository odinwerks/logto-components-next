...
export const enUS: Translations = {
  ...
  profile: {
    ...
    avatarPreviewHint: 'File selected for preview. Wire uploadAvatarToStorage() to auto-fill, or paste a hosted URL.',
    avatarUrlHint: 'Logto requires a public https:// URL. Wire uploadAvatarToStorage() to fill this automatically.',
