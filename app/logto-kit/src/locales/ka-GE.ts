...
export const kaGE: Translations = {
  ...
  security: {
    title: 'უსაფრთხოება',
    description: 'აუთენტიფიკაციის მეთოდები, სესიები და ანგარიშზე წვდომა.',
    twoFactorAuth: 'ორფაქტორიანი აუთენტიფიკაცია',
    authenticatorApp: 'აუთენტიფიკატორი',
    authenticatorDescription: 'TOTP Google Authenticator-ით, Authy ან 1Password-ით.',
    totpActive: 'აქტიური',
    totpInactive: 'ინაქტიური',
    viewRecoveryCodes: 'Recovery კოდების ნახვა',
    reconfigure: 'თავიდან კონფიგურაცია',
    smsBackup: 'SMS სარეზერვო',
    smsBackupDescription: 'SMS-ით ერთჯერადი კოდის მიღება.',
