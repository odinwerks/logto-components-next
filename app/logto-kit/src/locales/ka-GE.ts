...
export const kaGE: Translations = {
  ...
  profile: {
    ...
    invalidUrl: 'გთხოვთ შეიყვანეთ ვალიდური URL.',
    urlMustBeHttp: 'URL უნდა იწყებოდეს http:// ან https://-ით',
    avatarPreviewHint: 'ფაილი არჩეულია წინასწარი გადახედვისთვის. დააყენეთ uploadAvatarToStorage() ავტომატური შესავსებლად, ან ჩასვით ჰოსტირებული URL.',
    avatarUrlHint: 'Logto-ს სჭირდება საჯარო https:// URL. დააყენეთ uploadAvatarToStorage() ავტომატური შესავსებლად.',
