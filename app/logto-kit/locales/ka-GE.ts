...
export const kaGE: Translations = {
  ...
  dev: {
    title: 'DEV',
    description: 'მართეთ ტოკენები სკრიპტებისა და CI/CD-ისთვის.',
    verifyToView: 'პირადობის დადასტურება',
    verifyToViewDesc: 'შეიყვანეთ პაროლი თქვენი ტოკენების სანახავად.',
    verifyToActionDesc: 'გასაგრძელებლად შეიყვანეთ პაროლი.',
    createToken: 'ტოკენის შექმნა',
    createDesc: 'მიუთითეთ სახელი და ვადა.',
    tokenName: 'ტოკენის სახელი',
    namePlaceholder: 'my-ci-token',
    expiresLabel: 'ვადა',
    neverExpires: 'არასოდეს',
    expiry30Days: '30 დღე',
    expiry60Days: '60 დღე',
    expiry90Days: '90 დღე',
    expiry1Year: '1 წელი',
    created: 'შეიქმნა',
    expires: 'იწურება',
    noTokens: 'ტოკენები ჯერ არ არის.',
    rename: 'გადარქმევა',
    renameTitle: 'ტოკენის გადარქმევა',
    renameDesc: 'აირჩიეთ ამ ტოკენის ახალი სახელი.',
    newNameLabel: 'ახალი სახელი',
    save: 'შენახვა',
    renamed: 'ტოკენს სახელი გადაერქვა',
    delete: 'წაშლა',
    deleteTitle: 'წავშალო ტოკენი?',
    deleteDesc: 'ეს სამუდამოდ გააუქმებს „{name}“-ს და შეაჩერებს ყველაფერს, რაც მას იყენებს.',
    deleted: 'ტოკენი გაუქმდა',
    createdMsg: 'ტოკენი შეიქმნა',
    valueTitle: 'ტოკენი შეიქმნა',
    refreshData: 'განახლება',
    loadFailed: 'ტოკენების ჩატვირთვა ვერ მოხერხდა.',
    nameRequired: 'სახელი აუცილებელია',
    nameTooLong: 'სახელი ძალიან გრძელია (მაქს. 256 სიმბოლო)',
    invalidExpiry: 'ვადა მომავალში უნდა იყოს',
    createFailed: 'ტოკენის შექმნა ვერ მოხერხდა',
    renameFailed: 'ტოკენის გადარქმევა ვერ მოხერხდა',
    deleteFailed: 'ტოკენის წაშლა ვერ მოხერხდა',
    nameInUse: 'ამ სახელით ტოკენი უკვე არსებობს',
    mayHaveCreated: 'თუ ტოკენი მაინც შეიქმნა, ხელახლა ცდამდე წაშალეთ ის სიიდან.',
  },
  // Common
  common: {
    copy: 'კოპირება',
  ...
  errors: {
    ...
    PAT_DISABLED: 'პერსონალური წვდომის ტოკენების მართვა გამორთულია.',
    PAT_FETCH_FAILED: 'ტოკენების ჩატვირთვა ვერ მოხერხდა.',
    PAT_CREATE_FAILED: 'ტოკენის შექმნა ვერ მოხერხდა.',
    PAT_RENAME_FAILED: 'ტოკენის გადარქმევა ვერ მოხერხდა.',
    PAT_DELETE_FAILED: 'ტოკენის წაშლა ვერ მოხერხდა.',
    PAT_NAME_IN_USE: 'ამ სახელით ტოკენი უკვე არსებობს.',
    INVALID_PAT_NAME: 'შეიყვანეთ სწორი ტოკენის სახელი.',
    PAT_NAME_TOO_LONG: 'ტოკენის სახელი არ უნდა აღემატებოდეს 256 სიმბოლოს.',
    INVALID_PAT_EXPIRY: 'ვადა მომავალ თარიღზე უნდა იყოს.',
