...
const EXPECTED_ERROR_KEYS = [
  ...
  'PAT_DISABLED', 'PAT_FETCH_FAILED', 'PAT_CREATE_FAILED', 'PAT_RENAME_FAILED', 'PAT_DELETE_FAILED',

  // ── validation (PAT name conflict / name shape / expiry) ──
  'PAT_NAME_IN_USE', 'INVALID_PAT_NAME', 'PAT_NAME_TOO_LONG', 'INVALID_PAT_EXPIRY',
