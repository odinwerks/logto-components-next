...
export const enUS: Translations = {
  ...
  dev: {
    title: 'DEV',
    description: 'Manage tokens for scripts and CI/CD.',
    verifyToView: 'Verify your identity',
    verifyToViewDesc: 'Enter your password to view your tokens.',
    verifyToActionDesc: 'Enter your password to continue.',
    createToken: 'Create token',
    createDesc: 'Set a name and expiry.',
    ...
    renameDesc: 'Choose a new name for this token.',
    newNameLabel: 'New name',
    save: 'Save',
    renamed: 'Token renamed',
    delete: 'Delete',
    deleteTitle: 'Delete token?',
    deleteDesc: 'This permanently revokes "{name}" and stops anything using it.',
    deleted: 'Token revoked',
    createdMsg: 'Token created',
    valueTitle: 'Token created',
    refreshData: 'Refresh',
    loadFailed: 'Failed to load tokens.',
    nameRequired: 'Name is required',
    nameTooLong: 'Name too long (max 256 characters)',
    invalidExpiry: 'Expiry must be in the future',
    createFailed: 'Failed to create token',
    renameFailed: 'Failed to rename token',
    deleteFailed: 'Failed to delete token',
    nameInUse: 'A token with this name already exists',
    mayHaveCreated: 'If the token was created, delete it from the list before retrying.',
  },
  // Common
  common: {
    copy: 'COPY',
  ...
  errors: {
    ...
    PAT_DISABLED: 'Personal access token management is disabled.',
    PAT_FETCH_FAILED: "Failed to load tokens.",
    PAT_CREATE_FAILED: "Failed to create token.",
    PAT_RENAME_FAILED: "Failed to rename token.",
    PAT_DELETE_FAILED: "Failed to delete token.",
    PAT_NAME_IN_USE: "A token with this name already exists.",
    INVALID_PAT_NAME: 'Enter a valid token name.',
    PAT_NAME_TOO_LONG: 'Token names must be 256 characters or fewer.',
    INVALID_PAT_EXPIRY: 'Expiry must be a future date.',
