...
export const ukUA: Translations = {
  ...
  dev: {
    title: 'DEV',
    description: 'Керуйте токенами для скриптів і CI/CD.',
    verifyToView: 'Підтвердьте особу',
    verifyToViewDesc: 'Введіть пароль, щоб переглянути свої токени.',
    verifyToActionDesc: 'Введіть пароль, щоб продовжити.',
    createToken: 'Створити токен',
    createDesc: 'Укажіть назву та строк дії.',
    tokenName: 'Назва токена',
    namePlaceholder: 'my-ci-token',
    expiresLabel: 'Діє до',
    neverExpires: 'Ніколи',
    expiry30Days: '30 днів',
    expiry60Days: '60 днів',
    expiry90Days: '90 днів',
    expiry1Year: '1 рік',
    created: 'Створено',
    expires: 'Закінчується',
    noTokens: 'Токенів ще немає.',
    rename: 'Перейменувати',
    renameTitle: 'Перейменувати токен',
    renameDesc: 'Виберіть нову назву для цього токена.',
    newNameLabel: 'Нова назва',
    save: 'Зберегти',
    renamed: 'Токен перейменовано',
    delete: 'Видалити',
    deleteTitle: 'Видалити токен?',
    deleteDesc: 'Це назавжди відкличе «{name}» і зупинить усе, що його використовує.',
    deleted: 'Токен відкликано',
    createdMsg: 'Токен створено',
    valueTitle: 'Токен створено',
    refreshData: 'Оновити',
    loadFailed: 'Не вдалося завантажити токени.',
    nameRequired: "Назва обов'язкова",
    nameTooLong: 'Назва задовга (макс. 256 символів)',
    invalidExpiry: 'Термін дії має бути в майбутньому',
    createFailed: 'Не вдалося створити токен',
    renameFailed: 'Не вдалося перейменувати токен',
    deleteFailed: 'Не вдалося видалити токен',
    nameInUse: 'Токен із такою назвою вже існує',
    mayHaveCreated: 'Якщо токен було створено, видаліть його зі списку перед повторною спробою.',
  },
  // Common
  common: {
    copy: 'КОПІЮВАТИ',
  ...
  errors: {
    ...
    BACKUP_CODES_SINGLETON_CONFLICT: 'Резервні коди вже існують і не можуть бути замінені автоматично. Видаліть поточні резервні коди, потім спробуйте ще раз.',
    ...
    PAT_DISABLED: 'Керування персональними токенами доступу вимкнено.',
    PAT_FETCH_FAILED: 'Не вдалося завантажити токени.',
    PAT_CREATE_FAILED: 'Не вдалося створити токен.',
    PAT_RENAME_FAILED: 'Не вдалося перейменувати токен.',
    PAT_DELETE_FAILED: 'Не вдалося видалити токен.',
    PAT_NAME_IN_USE: 'Токен із такою назвою вже існує.',
    INVALID_PAT_NAME: 'Введіть припустиму назву токена.',
    PAT_NAME_TOO_LONG: 'Назва токена має містити не більше 256 символів.',
    INVALID_PAT_EXPIRY: 'Термін дії має бути в майбутньому.',
