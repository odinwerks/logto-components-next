...
export const SECTION_HINTS: SectionHint = {
  ...
  Profile: 'User profile management actions, forms, and attributes...',
  Preferences: 'User preferences, language selection, and theme configurations...',
  Security: 'Multi-factor authentication (MFA/TOTP) setup, recovery options, and session tracking...',
  Organizations: 'Organization creation, member management, and role viewing...',
  Dev: 'Developer logs, raw access tokens, and sandbox tools...',
